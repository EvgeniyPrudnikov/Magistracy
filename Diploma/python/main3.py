...
def train_model():
    ...
    X_train, X_test, y_train, y_test = train_test_split(train_data[features], train_data.Response, test_size=0.33, random_state=42)
    ...
    for i in range(folds):
        ...
        best_proba, best_mcc, y_pred = eval_mcc(y_test, (predictions / folds > 0.2365).astype(int), True)
